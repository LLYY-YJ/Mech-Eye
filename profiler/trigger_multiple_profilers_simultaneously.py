...
class CaptureThread(threading.Thread):
    ...
    def run(self):
        ...
        show_error(self.profiler.get_profiler_info(profiler_info))
        ...
        self.save_depth_and_intensity(
            "depth_" + profiler_info.sensor_sn + ".tiff", "intensity_" + profiler_info.sensor_sn + ".png")
...
class TriggerMultipleProfilersSimultaneously(object):
    ...
    def connect_device_and_capture(self):
        ...
        for profiler in self.profilers:
            capture_thread = CaptureThread(profiler)
